    ...
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      <div>
        <input
          ...
          focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none text-sm"
      ...
      <div>
        <textarea
          ...
          focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none resize-none text-sm"
