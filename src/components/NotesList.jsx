    ...
    <div className="bg-white rounded-xl shadow-lg p-8">
      ...
      <div className="flex flex-wrap gap-4 mb-6">
        <div>
          ...
          <select
            ...
            className="px-4 py-2 border-2 border-gray-200 rounded-lg focus:border-blue-500 outline-none transition-all"
          >
      ...
      {filteredNotes.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 text-lg">No notes available</p>
        ...
        <div className="grid gap-4">
          {filteredNotes.map((note) => (
            <div
              key={note.id}
              className="border-2 border-gray-100 rounded-lg p-5 hover:border-blue-300 hover:shadow-md transition-all"
            >
