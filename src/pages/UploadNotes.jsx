...
import { BookOpen, Upload, Users, Sparkles, GraduationCap } from "lucide-react";
      ...
      <div>
        ...
        <section className="container mx-auto px-6 py-12">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg hover:shadow-xl transition-all transform hover:scale-105">
        ...
        <footer className="relative bg-white/80 backdrop-blur-sm border-t border-blue-100 py-8">
          <div className="container mx-auto px-6 text-center">
            <p className="text-gray-600">
